...
CRGBPalette16 pacifica_palette_1 = { 0x000000, 0x000000, 0x000000, 0x001100, 0x001100, 0x001100, 0x002200, 0x002200,
    0x002200, 0x003300, 0x003300, 0x003300, 0x004400, 0x004400, 0x004400, 0x005500 };
//CRGBPalette16 pacifica_palette_2 = { 0x000507, 0x000409, 0x00030B, 0x00030D, 0x000210, 0x000212, 0x000114, 0x000117,
//    0x000019, 0x00001C, 0x000026, 0x000031, 0x00003B, 0x000046, 0x0C5F52, 0x19BE5F };
CRGBPalette16 pacifica_palette_2 = { 0x000507, 0x000409, 0x00030B, 0x00030D, 0x330210, 0x330202, 0x330104, 0x000107,
    0x002009, 0x00200C, 0x222006, 0x222001, 0x00200B, 0x552006, 0x0C5F02, 0x19BE0F };
...
{
    for (uint16_t i = 0; i < NUM_LEDS; i++) {
        leds[i].blue = scale8(leds[i].blue, 5);
        leds[i].green = scale8(leds[i].green, 250);
        leds[i] |= CRGB(2, 5, 7);
    }
}
